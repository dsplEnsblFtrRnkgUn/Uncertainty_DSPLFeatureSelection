package ABS.JUnit;
// abs/lang/abslang.abs:1357:53: 
public final class Result_Failure extends Result {
    ...
    public Result_Failure(final org.abs_models.backend.java.lib.types.ABSString arg0) {
        this.arg0 = arg0;
    }
    ...
    public java.lang.String getConstructorName() { return "Failure";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Result_Failure)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Result_Failure other = (Result_Failure) o;
