package ABS.JUnit;
// abs/lang/abslang.abs:1357:27: 
public final class Result_Skipped extends Result {
    public Result_Skipped() {
    }
    ...
    public java.lang.String getConstructorName() { return "Skipped";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Result_Skipped)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Result_Skipped other = (Result_Skipped) o;
