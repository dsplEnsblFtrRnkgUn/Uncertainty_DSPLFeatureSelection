package ABS.StdLib;
// abs/lang/abslang.abs:275:0: 
public final class difference_f implements org.abs_models.backend.java.lib.types.ABSFunction {
                    ...
                    public ABS.StdLib.Set<A> execute(final A e1, final ABS.StdLib.Set<A> ss1) { return new org.abs_models.backend.java.lib.expr.Case() {
                        public ABS.StdLib.Set<A> of(final ABS.StdLib.Set<A> ss1, final ABS.StdLib.Set<A> set2, final ABS.StdLib.Set<A> set1, final A e1, final ABS.StdLib.Set<A> __ABS_value) {
                            ...
                            if (__ABS_binding2 != null) return new Object() {
                                public ABS.StdLib.Set<A> execute(final A e2, final ABS.StdLib.Set<A> ss2) { return org.abs_models.backend.java.lib.expr.BinOp.lt(e1,e2).toBoolean() ? new ABS.StdLib.Set_Insert<>(e1, ABS.StdLib.difference_f.apply(ss1, set2)) : ABS.StdLib.difference_f.apply(set1, ss2); }
                            }.execute((A) __ABS_binding2.getBinding(0),(ABS.StdLib.Set<A>) __ABS_binding2.getBinding(1));
                            throw new org.abs_models.backend.java.lib.expr.UnmatchedCaseException("abs/lang/abslang.abs:278:26:  value " + __ABS_value + " did not match any pattern.");
                        }
                    }.of(ss1, set2, set1, e1, set2); }
                }.execute((A) __ABS_binding1.getBinding(0),(ABS.StdLib.Set<A>) __ABS_binding1.getBinding(1));
                throw new org.abs_models.backend.java.lib.expr.UnmatchedCaseException("abs/lang/abslang.abs:276:3:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(set2, set1, set1));
    }
}
