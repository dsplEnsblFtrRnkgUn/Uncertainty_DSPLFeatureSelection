...
public final class Feature_Open extends Feature {
    public Feature_Open() {
    }
    ...
    public java.lang.String getConstructorName() { return "Open";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Feature_Open)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Feature_Open other = (Feature_Open) o;
