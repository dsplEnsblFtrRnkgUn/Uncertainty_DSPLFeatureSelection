...
public final class Feature_Door extends Feature {
    public Feature_Door() {
    }
    ...
    public java.lang.String getConstructorName() { return "Door";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Feature_Door)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Feature_Door other = (Feature_Door) o;
