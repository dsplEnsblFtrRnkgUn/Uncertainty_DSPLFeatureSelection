...
public final class Feature_Window extends Feature {
    public Feature_Window() {
    }
    ...
    public java.lang.String getConstructorName() { return "Window";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Feature_Window)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Feature_Window other = (Feature_Window) o;
