...
public final class Feature_Lightoff extends Feature {
    public Feature_Lightoff() {
    }
    ...
    public java.lang.String getConstructorName() { return "Lightoff";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Feature_Lightoff)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Feature_Lightoff other = (Feature_Lightoff) o;
