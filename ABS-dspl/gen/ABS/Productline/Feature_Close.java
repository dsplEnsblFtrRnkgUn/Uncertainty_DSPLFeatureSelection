...
public final class Feature_Close extends Feature {
    public Feature_Close() {
    }
    ...
    public java.lang.String getConstructorName() { return "Close";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Feature_Close)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Feature_Close other = (Feature_Close) o;
