...
public final class Feature_Wclose extends Feature {
    public Feature_Wclose() {
    }
    ...
    public java.lang.String getConstructorName() { return "Wclose";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Feature_Wclose)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Feature_Wclose other = (Feature_Wclose) o;
