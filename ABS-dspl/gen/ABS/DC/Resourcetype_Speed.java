package ABS.DC;
// abs/lang/abslang.abs:765:2: 
public final class Resourcetype_Speed extends Resourcetype {
    public Resourcetype_Speed() {
    }
    ...
    public java.lang.String getConstructorName() { return "Speed";}
    public org.abs_models.backend.java.lib.types.ABSBool eq(org.abs_models.backend.java.lib.types.ABSValue o) {
        if (! (o instanceof Resourcetype_Speed)) return org.abs_models.backend.java.lib.types.ABSBool.FALSE;
        Resourcetype_Speed other = (Resourcetype_Speed) o;
