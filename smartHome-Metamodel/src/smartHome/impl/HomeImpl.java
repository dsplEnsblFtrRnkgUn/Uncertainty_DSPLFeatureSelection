 ...
 * </p>
 * <ul>
 *   <li>{@link smartHome.impl.HomeImpl#getName <em>Name</em>}</li>
 *   <li>{@link smartHome.impl.HomeImpl#getRoom <em>Room</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HomeImpl extends MinimalEObjectImpl.Container implements Home {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.HOME__NAME, oldName, name));
	}
	...
	public EList<Room> getRoom() {
		if (room == null) {
			room = new EObjectContainmentEList<Room>(Room.class, this, SmartHomePackage.HOME__ROOM);
		}
		return room;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmartHomePackage.HOME__ROOM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmartHomePackage.HOME__NAME:
				return getName();
			case SmartHomePackage.HOME__ROOM:
				return getRoom();
		}
