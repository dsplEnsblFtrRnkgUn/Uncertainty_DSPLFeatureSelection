 ...
 * </p>
 * <ul>
 *   <li>{@link smartHome.impl.DoorImpl#getName <em>Name</em>}</li>
 *   <li>{@link smartHome.impl.DoorImpl#getIsOpen <em>Is Open</em>}</li>
 *   <li>{@link smartHome.impl.DoorImpl#getUweight <em>Uweight</em>}</li>
 *   <li>{@link smartHome.impl.DoorImpl#getRoom <em>Room</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoorImpl extends Prob_FactorImpl implements Door {
	/**
	...
	protected EClass eStaticClass() {
		return SmartHomePackage.Literals.DOOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.DOOR__NAME, oldName, name));
	}
	...
	public void setIsOpen(Boolean newIsOpen) {
		...
		isOpen = newIsOpen;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.DOOR__IS_OPEN, oldIsOpen, isOpen));
	}
	...
	public void setUweight(BigDecimal newUweight) {
		...
		uweight = newUweight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.DOOR__UWEIGHT, oldUweight, uweight));
	}
	 ...
	 */
	public Room getRoom() {
		if (eContainerFeatureID() != SmartHomePackage.DOOR__ROOM) return null;
	...
	public NotificationChain basicSetRoom(Room newRoom, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newRoom, SmartHomePackage.DOOR__ROOM, msgs);
		return msgs;
	}
	...
	public void setRoom(Room newRoom) {
		if (newRoom != eInternalContainer() || (eContainerFeatureID() != SmartHomePackage.DOOR__ROOM && newRoom != null)) {
			...
			if (newRoom != null)
				msgs = ((InternalEObject)newRoom).eInverseAdd(this, SmartHomePackage.ROOM__DOORS, Room.class, msgs);
			msgs = basicSetRoom(newRoom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmartHomePackage.DOOR__ROOM, newRoom, newRoom));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmartHomePackage.DOOR__ROOM:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SmartHomePackage.DOOR__ROOM:
				return eInternalContainer().eInverseRemove(this, SmartHomePackage.ROOM__DOORS, Room.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmartHomePackage.DOOR__NAME:
				return getName();
			case SmartHomePackage.DOOR__IS_OPEN:
				return getIsOpen();
			case SmartHomePackage.DOOR__UWEIGHT:
				return getUweight();
			case SmartHomePackage.DOOR__ROOM:
				return getRoom();
		}
