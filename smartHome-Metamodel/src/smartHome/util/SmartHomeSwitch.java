...
public class SmartHomeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SmartHomePackage.HEATER: {
				...
				if (result == null) result = caseProb_Factor(heater);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartHomePackage.WINDOW: {
				...
				if (result == null) result = caseProb_Factor(window);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartHomePackage.DOOR: {
				...
				if (result == null) result = caseProb_Factor(door);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SmartHomePackage.LIGHT: {
				...
				if (result == null) result = caseProb_Factor(light);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SmartHomePackage.PROB_FACTOR: {
				Prob_Factor prob_Factor = (Prob_Factor)theEObject;
				T result = caseProb_Factor(prob_Factor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Prob Factor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Prob Factor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProb_Factor(Prob_Factor object) {
		return null;
	}
